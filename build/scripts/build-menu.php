...
gv_item($menu_id, 'Development', '/athlete-development/');
gv_item($menu_id, 'Success Stories', '/success-stories/');
gv_item($menu_id, 'Gallery', '/gallery/');
gv_item($menu_id, 'FAQ', '/faq/');
gv_item($menu_id, 'Contact', '/contact/');
gv_item($menu_id, 'Request Training', '/book-a-consultation/', 0, 'gv-navcta');
