...
0b. **Coaching Credentials & Certifications (July 11):** Phil Handy now shows as **Assistant Coach · Dallas Mavericks** (was LA Lakers) on the home and About mentor cards and in the FAQ. The About page's navy section is now **"Certifications & Credentials"**, leading with Coach Gino's **94 Feet of Game** certification copy above the Phil Handy and Micah Lancaster cards. The official certificate is displayed beneath the certification copy, framed in gold. Documented in the JULY-v2 report (section 04). *(Certifications deliverable from the July 10 brief: received and live.)*
